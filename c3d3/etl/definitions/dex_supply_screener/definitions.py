...
from etl.assets.dex_supply_screener.assets import get_overview
from etl.ops.dex_supply_screener.ops import extract_from_d3vault, load_to_dwh
from etl.jobs.dex_supply_screener.jobs import dag
from etl.schedules.dex_supply_screener.schedules import every_1th_minute
...
dex_supply_screener = Definitions(
