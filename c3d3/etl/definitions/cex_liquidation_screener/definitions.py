...
from etl.assets.cex_liquidation_screener.assets import get_overview
from etl.ops.cex_liquidation_screener.ops import extract_from_c3vault, load_to_dwh
from etl.jobs.cex_liquidation_screener.jobs import dag
from etl.schedules.cex_liquidation_screener.schedules import every_1th_minute
...
cex_liquidation_screener = Definitions(
