...
def _etl(context, configs: dict) -> None:
    ...
    ts_down_border_dt = datetime.datetime.fromtimestamp(ts_down_border_ts) if ts_down_border_ts == delta_ts else datetime.datetime.fromtimestamp(ts_down_border_ts / 10 ** 9)
